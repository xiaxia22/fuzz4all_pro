...
**Source:** `java.desktop\javax\print\DocFlavor.html`
...
for more information on the character encodings supported on
the Java platform.
...
**Direct Known Subclasses:** DocFlavor.BYTE_ARRAY
...
converted to the canonical lower case format before performing
the match.
**Returns:** a string representing a mime parameter, or

...
**Source:** `java.base\java\util\Spliterators.AbstractDoubleSpliterator.html`
...
**Since:** 1.8
**See Also:** Spliterators.spliterator(java.util.PrimitiveIterator.OfDouble, long, int)
...
#### Methods declared in interface java.util. Spliterator.OfDouble

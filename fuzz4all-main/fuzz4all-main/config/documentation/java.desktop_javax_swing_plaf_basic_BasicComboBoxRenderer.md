...
**Source:** `java.desktop\javax\swing\plaf\basic\BasicComboBoxRenderer.html`
...
used by this renderer directly set it using
the
...
**Direct Known Subclasses:** BasicComboBoxRenderer.UIResource

...
**Source:** `java.base\java\lang\invoke\SwitchPoint.html`
...
**Returns:** true if this switch point has been invalidated
...
- the method handle selected by the switch point after it is invalidated
**Returns:** a combined method handle which always calls either the target or fallback
...
- if the two method types do not match
**See Also:** MethodHandles.guardWithTest(java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle, java.lang.invoke.MethodHandle)

...
**Source:** `java.base\java\security\SecurityPermission.html`
...
operations. The named provider must extend
...
. Since DomainCombiners may contain
...
associated with classes that have been deprecated:
...
method. Also, there is an equivalent

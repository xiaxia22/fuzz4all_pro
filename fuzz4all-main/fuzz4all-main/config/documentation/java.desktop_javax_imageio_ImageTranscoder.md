...
**Source:** `java.desktop\javax\imageio\ImageTranscoder.html`
...
The internal details of converting an

IIOMetadata

object into a writer-specific format will vary according to the
context of the operation. Typically, an
...
access it via the standard

IIOMetadata

interfaces such
as the tree view provided by
...
No independent implementations of
...
**All Known Implementing Classes:** ImageWriter

...
**Source:** `java.base\java\lang\module\ModuleDescriptor.Exports.Modifier.html`
...
**Enclosing class:** ModuleDescriptor.Exports
...
**Since:** 9
**See Also:** ModuleDescriptor.Exports.modifiers()

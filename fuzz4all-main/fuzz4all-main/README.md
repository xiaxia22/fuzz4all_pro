# <p style="text-align: center;">  馃寣锔廎uzz4All: Universal Fuzzing with LLMs </p>
...
if you want to use other model than qwen2.5, please change the name of model after `ollama/*`. 
Make sure you have model locally pulled.
The exact parameters will depend on the machine you are running `Fuzz4All` on.

> [!Note]
> This repository is configured by default for `Qwen/Qwen2.5-Coder-7B-Instruct` on HuggingFace and `ollama/qwen2.5-coder:7b`
> for local Ollama runs. See `model.py` for details on the generation backend.

To use the autoprompting mechanism of `Fuzz4All` via DeepSeek, please also export your DeepSeek key
...
Generating prompts... 鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣 100% 0:07:30
[INFO] Done
 (resuming from 0)
...
Fuzzing 鈥?  0% 鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣鈹佲攣     30/100000 鈥?0:02:26
```
</details>
